...
ArticlesListingModel articlesListingModelFromJson(String str) =>
    ArticlesListingModel.fromJson(json.decode(str));

String articlesListingModelToJson(ArticlesListingModel data) =>
    json.encode(data.toJson());

class ArticlesListingModel {
  ArticlesListingModel({
    this.status,
    this.copyright,
    this.numResults,
    this.results,
  ...
  factory ArticlesListingModel.fromJson(Map<String, dynamic> json) =>
      ArticlesListingModel(
        status: json["status"],
